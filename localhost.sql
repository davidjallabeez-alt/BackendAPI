...
-- Database: `Funo_db`
--
CREATE DATABASE IF NOT EXISTS `Funo_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `Funo_db`;
...
('root', '[{\"db\":\"SokoGarden\",\"table\":\"product_details\"},{\"db\":\"SokoGarden\",\"table\":\"users\"},{\"db\":\"company\",\"table\":\"workers\"},{\"db\":\"Funo_db\",\"table\":\"employees\"}]');
...
('root', 'SokoGarden', 'users', '{\"CREATE_TIME\":\"2026-03-03 14:06:00\",\"col_order\":[0,1,3,2,4],\"col_visib\":[1,1,1,1,1]}', '2026-03-06 10:43:24');
...
('root', '2026-03-13 08:19:31', '{\"Console\\/Mode\":\"show\"}');
...
-- Database: `SokoGarden`
--
CREATE DATABASE IF NOT EXISTS `SokoGarden` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `SokoGarden`;
